...
//RESULTS
    printf("Los datos que describen la orbita de Mercurio son los Siguientes: \n\n");
    printf("La posicion de Mercurio (x,y,z) en AU cuando h es 1 dia, es:  %f ,%f ,%f\n", posx1, posy1, posz1);
    printf("La velocidad de Mercurio (x,y,z) en AU/d cuando h es 1 dia, es: %f ,%f ,%f\n\n", velx1, vely1, velz1);

    printf("La posicion de Mercurio (x,y,z) en AU cuando h es 101 dias, es:  %f ,%f ,%f\n", posx2, posy2, posz2);
    printf("La velocidad de Mercurio (x,y,z) en AU/d cuando h es 101 dias, es: %f ,%f ,%f\n\n", velx2, vely2, velz2);

    printf("La posicion de Mercurio (x,y,z) en AU cuando h es 201 dias, es:  %f ,%f ,%f\n", posx3, posy3, posz3);
    printf("La velocidad de Mercurio (x,y,z) en AU/d cuando h es 201 dias, es: %f ,%f ,%f\n\n", velx3, vely3, velz3);

    printf("La posicion de Mercurio (x,y,z) en AU cuando h es 365 dias, es:  %f ,%f ,%f\n", posx4, posy4, posz4);
    printf("La velocidad de Mercurio (x,y,z) en AU/d cuando h es 365 dias, es: %f ,%f ,%f\n\n", velx4, vely4, velz4);
